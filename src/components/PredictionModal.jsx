...
const PredictionModal = ({ isOpen, onClose, params }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-cyber-black border-cyber-green-700 text-cyber-green-400 max-w-4xl">
        <DialogHeader>
          <DialogTitle className="text-cyber-green-400 text-xl font-mono">Detailed Prediction Analysis</DialogTitle>
        </DialogHeader>
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid w-full grid-cols-3 bg-cyber-green-900">
