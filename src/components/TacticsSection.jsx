...
const TacticsSection = () => {
  ...
  return (
    <Card className="bg-cyber-black border-cyber-green-700 mt-6">
      <CardHeader>
        <CardTitle className="text-cyber-green-400 text-lg font-mono">Civic Engagement Tactics</CardTitle>
      </CardHeader>
      <CardContent>
